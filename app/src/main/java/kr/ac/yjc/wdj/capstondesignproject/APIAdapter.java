...
import kr.ac.yjc.wdj.capstondesignproject.AddCookiesInterceptor;
import kr.ac.yjc.wdj.capstondesignproject.ReceivedCookiesInterceptor;
...
/**
 APIAdapter 클래스는
 OkHttpClient 를 이용하여 쿠키 관리를 위한 클라이언트 객체를 생성하고
 이것을 Retrofit 객체에 적용 및 생성하는 기능을 정의.
 */
